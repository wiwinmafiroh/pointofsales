...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $('body').on('click', '#tombol-tambahkan', function() {
            ...
            if (id.length == 0) {
                ...
                var table_pembelian =
                    ...
                    "<td align='center' style='background-color: #F5DEB3' > <input type='hidden' name='menu[]' value='" +
                    id +
                    ...
                    "<td align='right'  style='background-color: #F5DEB3'>Rp " + formatNumber(total_harga_peritem) +
                    ",</td>" +
                    "<td align='center'  style='background-color: #F5DEB3'> <span class='btn btn-sm btn-danger tombol-hapus-penjualan' total_harga_peritem='" +
                    total_harga_peritem +
                    "' quantity='" + quantity +
                    "' harga='" + harga +
                    "' id='" + id +
        ...
        $("body").on("input click change", ".total_diskon", function() {
            var diskon = $(this).val();
            if (diskon.length != 0 && diskon != "") {
                ...
                $(".total_pembelian").attr("id", hasil2);
            } else {
        ...
        // kembali
        $("body").on("input click change", ".total_bayar", function() {
            var bayar = $(this).val();
            var kembali = $(".total_kembali").attr("id");
            var total = $(".total_pembelian").attr("id");
            var hasil_bayar = bayar - total;
