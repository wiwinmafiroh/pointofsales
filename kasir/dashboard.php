            ...
            <div class="col-md">
              ...
              <div class="card card-dashboard text-white rounded-0" style="background-color: #F4A460">
                <div class="card-body">
                  ...
                  <h5 class="card-title"><?php echo "Rp ".number_format($p['total_penjualan'])."," ?></h5>
                  <p class="card-text text-right">
              ...
              <div class="card card-besar">
                <div class="card-body text-center">
                  ...
                  <br><h5>Selamat Datang di Aplikasi Point Of Sales Angkringan Lek'Tok</h5>
                </div>
              </div>
              </div>
