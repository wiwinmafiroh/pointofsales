...
<div class="col-md users">
    ...
    <h5>RIWAYAT TRANSAKSI <small>(Transaksi Yang Saya Layani)</small></h5>
              ...
              <tr>
                ...
                <td style="text-align: center;">
                  ...
                  <div class="btn-group">
                    ...
                    <button type="button" class="btn" data-toggle="modal" style="color: black; margin-bottom: 5px; width: 30%; border-radius: 4px; background-color: #ADD8E6; margin-right: 7px;" data-target="#detail_transaksi_riwayat_<?= $p['id_penjualan'] ?>">
                       <i class="fa fa-search"></i>
                    </button>

                    <a target="_blank" class="btn" style="color: black; margin-bottom: 5px; width: 30%; border-radius: 4px; background-color: #AFEEEE; margin-right: 7px;" href="transaksi_print.php?id=<?= $p['id_penjualan']; ?>">
                      <i class="fa fa-file"></i>
                    </a>

                  </div>

                    <div class="modal fade" id="detail_transaksi_riwayat_<?= $p['id_penjualan'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
